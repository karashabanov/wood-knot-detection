...
def draw_annotations(image: cv2.typing.MatLike, annotations: List[Tuple[int, float, float, float, float]]) -> cv2.typing.MatLike:
    """
    ...
    for annotation in annotations:
        class_id, x_min, y_min, x_max, y_max = (yolo_2_pixel_coordinates(annotation, width, height))
